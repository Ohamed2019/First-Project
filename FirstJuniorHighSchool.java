...
public class FirstJuniorHighSchool {
    ...
    public static void AffishingFirst (double[] array , double matiere)
    {
        ...
        */
        ...
        System.out.print("The educational cirriculum of Morroco consists of 8 subjects, namely: ");
        System.out.print("\nEducation Physique");
        System.out.print("\nHISTOIRE GEOGRAPHIE");
        ...
        do
        {
            ...
            CycleRateFirstSession=((EducationPhysiqueFirstSession*2)+(HistoireGeographieFirstSession*2)+(InstructionIslamiqueFirstSession*2)+(LangueArabeFirstSession*5)+(LangueFrancaiseFirstSession*5)+(MathematiquesFirstSession*5)+(PhysiqueChimieFirstSession*2)+(SciencesDeLaVieEtDeLaTerreFirstSession*3)+AssiduiteEtConduiteFirstSession)/27;
            //Showing points
        ...
        do
        {
            ...
            CycleRateSecondSession=((EducationPhysiqueSecondSession*2)+(HistoireGeographieSecondSession*2)+(InstructionIslamiqueSecondSession*2)+(LangueArabeSecondSession*5)+(LangueFrancaiseSecondSession*5)+(MathematiquesSecondSession*5)+(PhysiqueChimieSecondSession*2)+(SciencesDeLaVieEtDeLaTerreSecondSession*3)+AssiduiteEtConduiteSecondSession)/27;
            //Showing points
            System.out.print("Your notes is:\nEducationPhysique: \n");
