...
public class TroncCommunScientifique {
    ...
    public static void AffishingFirst (double[] array , double matiere)
    {
        ...
        */
        ...
        do
        {
            ...
            CycleRateFirstSession=((EducationPhysiqueFirstSession*2)+(HistoireGeographieFirstSession*2)+(InformatiqueFirstSession*2)+(InstructionIslamiqueFirstSession*2)+(LangueAnglaiseFirstSession*3)+(LangueArabeFirstSession*2)+(LangueFrancaiseFirstSession*3)+(MathematiquesFirstSession*4)+(PhilosophieFirstSession*2)+(PhysiqueChimieFirstSession*4)+(SciencesDeLaVieEtDeLaTerreFirstSession*4)+AssiduiteEtConduiteFirstSession)/31;
            //Showing points
        ...
        do
        {
            ...
            CycleRateSecondSession=((EducationPhysiqueSecondSession*2)+(HistoireGeographieSecondSession*2)+(InformatiqueSecondSession*2)+(InstructionIslamiqueSecondSession*2)+(LangueAnglaiseSecondSession*3)+(LangueArabeSecondSession*2)+(LangueFrancaiseSecondSession*3)+(MathematiquesSecondSession*4)+(PhilosophieSecondSession*2)+(PhysiqueChimieSecondSession*4)+(SciencesDeLaVieEtDeLaTerreSecondSession*4)+AssiduiteEtConduiteSecondSession)/31;
            //Showing points
            System.out.print("Your notes is:\nEducationPhysique: \n");
