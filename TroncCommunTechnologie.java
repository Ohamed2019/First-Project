...
public class TroncCommunTechnologie {
    ...
    public static void AffishingFirst (double[] array , double matiere)
    {
        ...
        */
        ...
        double PhilosophieFirstSession;
        double PhysiqueChimieFirstSession;
        double SciencesdIngenieursFirstSession;
        ...
        do
        {
            ...
            //PHILOSOPHIE
            System.out.print("\nPHILOSOPHIE \n---------\n---------\n");
            double FirstTestPhilosophieFirstSession;
            do
            {
                System.out.print("Enter the point of the first test: ");
                FirstTestPhilosophieFirstSession=input.nextDouble();
            }
            while(FirstTestPhilosophieFirstSession<0||FirstTestPhilosophieFirstSession>20);
            double SecondTestPhilosophieFirstSession;
            do
            {
                System.out.print("Enter the point of the Second test: ");
                SecondTestPhilosophieFirstSession=input.nextDouble();
            }
            while(SecondTestPhilosophieFirstSession<0||SecondTestPhilosophieFirstSession>20);
            double IntegratedActivitiesPhilosophieFirstSession;
            do
            {
                System.out.print("Enter the point of the Integrated Activities: ");
                IntegratedActivitiesPhilosophieFirstSession=input.nextDouble();
            }
            while(IntegratedActivitiesPhilosophieFirstSession<0||IntegratedActivitiesPhilosophieFirstSession>20);
            PhilosophieFirstSession=Third(FirstTestPhilosophieFirstSession,SecondTestPhilosophieFirstSession,IntegratedActivitiesPhilosophieFirstSession);
            double[] PhilosophieFirstSessionPoints={FirstTestPhilosophieFirstSession,SecondTestPhilosophieFirstSession,IntegratedActivitiesPhilosophieFirstSession};


            //SciencesdIngenieursFirstSession
            System.out.print("\nSciences d' Ingenieurs  \n---------\n---------\n");
            double FirstTestSciencesdIngenieursFirstSession;
            do
            {
                System.out.print("Enter the point of the first test: ");
                FirstTestSciencesdIngenieursFirstSession=input.nextDouble();
            }
            while(FirstTestSciencesdIngenieursFirstSession<0||FirstTestSciencesdIngenieursFirstSession>20);
            double SecondTestSciencesdIngenieursFirstSession;
            do
            {
                System.out.print("Enter the point of the Second test: ");
                SecondTestSciencesdIngenieursFirstSession=input.nextDouble();
            }
            while(SecondTestSciencesdIngenieursFirstSession<0||SecondTestSciencesdIngenieursFirstSession>20);
            double IntegratedActivitiesSciencesdIngenieursFirstSession;
            do
            {
                System.out.print("Enter the point of the Integrated Activities: ");
                IntegratedActivitiesSciencesdIngenieursFirstSession=input.nextDouble();
            }
            while(IntegratedActivitiesSciencesdIngenieursFirstSession<0||IntegratedActivitiesSciencesdIngenieursFirstSession>20);
            SciencesdIngenieursFirstSession=Third(FirstTestSciencesdIngenieursFirstSession,SecondTestSciencesdIngenieursFirstSession,IntegratedActivitiesSciencesdIngenieursFirstSession);
            double[] SciencesdIngenieursFirstSessionPoints={FirstTestSciencesdIngenieursFirstSession,SecondTestSciencesdIngenieursFirstSession,IntegratedActivitiesSciencesdIngenieursFirstSession};
            ...
            CycleRateFirstSession=((EducationPhysiqueFirstSession*2)+(HistoireGeographieFirstSession*2)+(InformatiqueFirstSession*3)+(InstructionIslamiqueFirstSession*2)+(LangueAnglaiseFirstSession*3)+(LangueArabeFirstSession*2)+(LangueFrancaiseFirstSession*3)+(MathematiquesFirstSession*4)+(PhilosophieFirstSession*2)+(PhysiqueChimieFirstSession*4)+(SciencesdIngenieursFirstSession*4)+AssiduiteEtConduiteFirstSession)/32;
            //Showing points
            ...
            System.out.print("\n-------\n-----\n-----\n----");
            System.out.print("\nPhilosophie: \n");
            AffishingThird(PhilosophieFirstSessionPoints,PhilosophieFirstSession);
            System.out.print("\n-------\n-----\n-----\n----");
            System.out.print("\nPhysiqueChimie: \n");
            AffishingFirst(PhysiqueChimieFirstSessionPoints,PhysiqueChimieFirstSession);
            System.out.print("\n-------\n-----\n-----\n----");
            System.out.print("\nSciences d' Ingenieurs: \n");
            AffishingThird(SciencesdIngenieursFirstSessionPoints,SciencesdIngenieursFirstSession);
            System.out.print("\n-------\n-----\n-----\n----");
        ...
        double PhilosophieSecondSession;
        double PhysiqueChimieSecondSession;
        double SciencesdIngenieursSecondSession;
        double AssiduiteEtConduiteSecondSession;
        double CycleRateSecondSession;
        //Entering Points
        System.out.print("\nNow, Start Entering your points of the second session: ");
        //Education Physique
        System.out.print("\nEducation Physique\n---------\n---------\n");
        ...
        do
        {
            ...
            //PHILOSOPHIE
            System.out.print("\nPHILOSOPHIE \n---------\n---------\n");
            double FirstTestPhilosophieSecondSession;
            do
            {
                System.out.print("Enter the point of the first test: ");
                FirstTestPhilosophieSecondSession=input.nextDouble();
            }
            while(FirstTestPhilosophieSecondSession<0||FirstTestPhilosophieSecondSession>20);
            double SecondTestPhilosophieSecondSession;
            do
            {
                System.out.print("Enter the point of the Second test: ");
                SecondTestPhilosophieSecondSession=input.nextDouble();
            }
            while(SecondTestPhilosophieSecondSession<0||SecondTestPhilosophieSecondSession>20);
            double IntegratedActivitiesPhilosophieSecondSession;
            do
            {
                System.out.print("Enter the point of the Integrated Activities: ");
                IntegratedActivitiesPhilosophieSecondSession=input.nextDouble();
            }
            while(IntegratedActivitiesPhilosophieSecondSession<0||IntegratedActivitiesPhilosophieSecondSession>20);
            PhilosophieSecondSession=Third(FirstTestPhilosophieSecondSession,SecondTestPhilosophieSecondSession,IntegratedActivitiesPhilosophieSecondSession);
            double[] PhilosophieSecondSessionPoints={FirstTestPhilosophieSecondSession,SecondTestPhilosophieSecondSession,IntegratedActivitiesPhilosophieSecondSession};


            //Sciences d' Ingenieurs
            System.out.print("\nSciences d' Ingenieurs \n---------\n---------\n");
            double FirstTestSciencesdIngenieursSecondSession;
            do
            {
                System.out.print("Enter the point of the first test: ");
                FirstTestSciencesdIngenieursSecondSession=input.nextDouble();
            }
            while(FirstTestSciencesdIngenieursSecondSession<0||FirstTestSciencesdIngenieursSecondSession>20);
            double SecondTestSciencesdIngenieursSecondSession;
            do
            {
                System.out.print("Enter the point of the Second test: ");
                SecondTestSciencesdIngenieursSecondSession=input.nextDouble();
            }
            while(SecondTestSciencesdIngenieursSecondSession<0||SecondTestSciencesdIngenieursSecondSession>20);
            double IntegratedActivitiesSciencesdIngenieursSecondSession;
            do
            {
                System.out.print("Enter the point of the Integrated Activities: ");
                IntegratedActivitiesSciencesdIngenieursSecondSession=input.nextDouble();
            }
            while(IntegratedActivitiesSciencesdIngenieursSecondSession<0||IntegratedActivitiesSciencesdIngenieursSecondSession>20);
            SciencesdIngenieursSecondSession=Third(FirstTestSciencesdIngenieursSecondSession,SecondTestSciencesdIngenieursSecondSession,IntegratedActivitiesSciencesdIngenieursSecondSession);
            double[] SciencesdIngenieursSecondSessionPoints={FirstTestSciencesdIngenieursSecondSession,SecondTestSciencesdIngenieursSecondSession,IntegratedActivitiesSciencesdIngenieursSecondSession};
            ...
            CycleRateSecondSession=((EducationPhysiqueSecondSession*2)+(HistoireGeographieSecondSession*2)+(InformatiqueSecondSession*3)+(InstructionIslamiqueSecondSession*2)+(LangueAnglaiseSecondSession*3)+(LangueArabeSecondSession*2)+(LangueFrancaiseSecondSession*3)+(MathematiquesSecondSession*4)+(PhilosophieSecondSession*2)+(PhysiqueChimieSecondSession*4)+(SciencesdIngenieursSecondSession*4)+AssiduiteEtConduiteSecondSession)/32;
            //Showing points
            System.out.print("Your notes is:\nEducationPhysique: \n");
            ...
            System.out.print("\n-------\n-----\n-----\n----");
            System.out.print("\nPhilosophie: \n");
            AffishingThird(PhilosophieSecondSessionPoints,PhilosophieSecondSession);
            System.out.print("\n-------\n-----\n-----\n----");
            System.out.print("\nPhysiqueChimie: \n");
            AffishingFirst(PhysiqueChimieSecondSessionPoints,PhysiqueChimieSecondSession);
            System.out.print("\n-------\n-----\n-----\n----");
            System.out.print("\nSciences d' Ingenieurs: \n");
            AffishingThird(SciencesdIngenieursSecondSessionPoints,SciencesdIngenieursSecondSession);
            System.out.print("\n-------\n-----\n-----\n----");
